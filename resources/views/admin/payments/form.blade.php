...
<div class="form-group {{ $errors->has('Paymenttypes') ? 'has-error' : ''}}">
    <label for="Paymenttypes" class="control-label">{{ 'Paymenttypes' }}</label>
    <input class="form-control" name="Paymenttypes" type="text" id="Paymenttypes" value="{{ isset($payment->Paymenttypes) ? $payment->Paymenttypes : ''}}" >
